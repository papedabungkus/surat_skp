...
$config = conn($host, $username, $password, $database);
    ...
    if(empty($_SESSION['admin'])){
    	...
    	$query = mysqli_query($config, "SELECT * FROM tbl_surat_perintah_tugas WHERE id_surat='$id_surat'");
    		  ...
    		  echo '<!-- Row form Start -->
				    ...
				    <div class="col m12">
                        <div class="card">
                            ...
                            <div class="card-action">
        		                <a href="?page=bspt&act=del&submit=yes&id_surat='.$row['id_surat'].'" class="btn-large deep-orange waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
        		                <a href="?page=bspt" class="btn-large blue waves-effect waves-light white-text">BATAL <i class="material-icons">clear</i></a>
                            </div>
                        </div>
                    </div>
                </div>
            	...
            	if(isset($_REQUEST['submit'])){
                    ...
                    if(!empty($row['file'])){
                        ...
                        $query = mysqli_query($config, "DELETE FROM tbl_surat_perintah_tugas WHERE id_surat='$id_surat'");
                		...
                		if($query == true && $querysuratkeluar == true){
                            ...
                            echo '<script language="javascript">
                                    window.location.href="./admin.php?page=bspt&act=del&id_surat='.$id_surat.'";
                                  </script>';
                		}
                	} else {
