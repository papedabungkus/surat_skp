...
$query = mysqli_query($config, "SELECT * FROM tbl_surat_perintah_tugas_pengawasan WHERE id_surat='$id_surat'");
if(mysqli_num_rows($query) > 0){
    $no = 0;
    while($row = mysqli_fetch_array($query)){
?>
<html>
<head><title>Surat Perintah Tugas - <?=$row['no_surat']?></title></head>
<style type="text/css">
    ...
    <div class="page">
        ...
        <div class="isisurat">
            ...
            <table width="90%" align="left">
                ...
                <tr valign="top">
                    <td colspan="3"><br /><p align="justify">Demikian Surat Perintah Tugas ini dibuat untuk dilaksanakan dengan penuh tanggung jawab dan dapat dipergunakan sebagaimana mestinya.<br /><br /><br /></td>
                </tr>
                <tr>
                    <td colspan="3">
