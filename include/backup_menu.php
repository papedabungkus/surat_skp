                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            if(!empty($data['logo'])){
                                ...
                                echo '<img class="logoside" src="./asset/img/noimage.png"/>';
                            }
                            if(!empty($data['nama'])){
                                echo '<h5 class="smk-side">'.$data['nama'].'</h5>';
                            } else {
                                echo '<h5 class="smk-side">Anda Belum Memasukkan Nama Instansi</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Anda Belum Memasukkan Alamat Instansi</p>';
                            }
                        }
                    ?>
                </div>
