<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            $query = mysqli_query($config, "SELECT no_agenda,no_surat,pertimbangan,dasar,penerima_tugas,peruntukan,tgl_ttd,tempat_ttd,nama_ttd,id_user FROM tbl_surat_tugas WHERE id_surat='$id_surat'");
            list($no_agenda, $no_surat, $pertimbangan, $dasar, $penerima_tugas, $peruntukan, $tgl_ttd, $tempat_ttd, $nama_ttd, $id_user) = mysqli_fetch_array($query);
