        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['sub'])){
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    if ($_REQUEST['nama'] == "" || $_REQUEST['alamat'] == "" || $_REQUEST['pimpinan'] == "" || $_REQUEST['nomortelp'] == ""
                                                        ...
                                                        if(!empty($logo)){
                                                            ...
                                                            if(in_array($eks, $ekstensi) == true){
                                                                if($ukuran < 2000000){
                                                                    ...
                                                                    $query = mysqli_query($config, "UPDATE tbl_instansi SET nama='$nama',alamat='$alamat',pimpinan='$pimpinan',nomortelp='$nomortelp',website='$website',email='$email',logo='$nlogo',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_instansi SET nama='$nama',alamat='$alamat',pimpinan='$pimpinan',nomortelp='$nomortelp',website='$website',email='$email',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                            ...
                            <form class="col s12" method="post" action="?page=sett" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="pegawai" type="text" class="validate" name="pimpinan" value="<?php echo $row['pimpinan']; ?>" required>
                                            <?php
                                                if(isset($_SESSION['pimpinan'])){
                                                    $kepsek = $_SESSION['pimpinan'];
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="nomortelp" type="text" class="validate" name="nomortelp" value="<?php echo $row['nomortelp']; ?>" required>
                                            <?php
                                                if(isset($_SESSION['nomortelp'])){
                                                    $nomortelp = $_SESSION['nomortelp'];
                                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$nomortelp.'</div>';
                                                    unset($_SESSION['nomortelp']);
                                                }
                                            ?>
                                        <label for="nip">No. Telp Kantor</label>
                                    </div>
                                    <div class="input-field col s6">
